...
<div class="container">
    ...
    <br/>
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.idcardno.$touch()" id="idcardno" class="form-control" type="text" v-model.trim="idcardno" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.name.$touch()" id="name" class="form-control" type="text" v-model.trim="name" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.surname.$touch()" id="name" class="form-control" type="text" v-model.trim="surname" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.dob.$touch()" id="dob" class="form-control" type="date" v-model.trim="dob" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <select @blur="$v.nation.$touch()" id="nation" name="nation" class="form-control" v-model.trim="nation" required>
            <option value=""></option>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <select @blur="$v.gender.$touch()" id="gender" name="gender" class="form-control" v-model.trim="gender" required>
            <option value=""></option>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.email.$touch()" id="email" class="form-control" type="text" v-model.trim="email" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.password.$touch()" id="password" class="form-control" type="password" v-model.trim="password" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <input @blur="$v.cpassword.$touch()" id="cpassword" class="form-control" type="password" v-model.trim="cpassword" required/>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">          
          <input @blur="$v.telephone.$touch()" id="telephone" class="form-control" type="tel" v-model.trim="telephone" required/>  
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <select @blur="$v.status.$touch()" id="status" name="status" class="form-control" v-model.trim="status" required>
            <option value=""></option>
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-6">
          <select @blur="$v.club.$touch()" id="club" name="club" class="form-control" v-model.trim="club" required>
            <option value=""></option>
  ...
  methods: {
    ...
    async getUserData(id){
      try{
        ...
        console.log("Getting data of one member " + responseData);
...
input:required:invalid {
    background-color: rgba(129, 32, 32, 0.219) ;
